        ...
        if (permission === 'denied') {
            return (
                <button
                    ...
                    className="px-2 py-2 sm:px-3 sm:py-1 flex items-center gap-1.5 bg-[var(--color-error)]/10 text-[var(--color-error)] opacity-60 cursor-not-allowed rounded-full text-xs font-medium whitespace-nowrap"
                >
        ...
        if (permission === 'default') {
            return (
                <button
                    ...
                    className="px-2 py-2 sm:px-3 sm:py-1.5 flex items-center gap-1.5 bg-[var(--color-primary)]/10 text-[var(--color-primary)] hover:bg-[var(--color-primary)]/20 rounded-full text-xs font-medium transition-all animate-pulse whitespace-nowrap"
                >
                    <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
